...
export class FileUploadController {
  ...
  @Get('presigned-url')
  @ApiOperation({
    summary: 'Get a presigned URL for direct S3 upload (for very large files)',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns uploadUrl and final fileUrl.',
  })
  async presignedUrl(
    ...
    return this.fileUploadService.getPresignedUploadUrl(
      filename,
      mimetype,
      folder,
    );
    ...
    schema: {
      ...
      properties: {
        fileUrl: {
          type: 'string',
          example:
            'https://bucket.s3.region.amazonaws.com/vital-signs/uuid.pdf',
        },
      },
    },
  })
