...
export class UserController {
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Step 3 — Save medical conditions (completes onboarding)' })
  saveMedicalHistory(
    @CurrentUser() user: UserDocument,
  ...
  @ApiOperation({ summary: 'Update a specific condition by index (follow-up Q&A)' })
  updateCondition(
    @CurrentUser() user: UserDocument ,
