...
import {
  IsString, IsEnum, IsMongoId, IsBoolean,
  IsOptional, IsArray, IsDateString,
  IsNumber, Min, ValidateIf,
...
export class CreateNoteDto {
  ...
  @ApiPropertyOptional({ example: ["https://bucket.s3.region.amazonaws.com/notes/uuid.jpg"] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({ enum: ReminderRepeatUnit, example: ReminderRepeatUnit.DAYS })
  @IsOptional()
