...
import {
  IsString, IsNumber, IsMongoId, IsEnum,
  IsDateString, IsBoolean, IsOptional,
  IsArray, ValidateNested, Min, IsUrl,
...
export class CreateVitalSignDto {
  ...
  @ApiProperty({ example: "blood_pressure", description: "Type of vital sign or lab test" })
  @IsString()
  type: string;
  ...
  @ApiPropertyOptional({ type: NormalRangeDto, description: "Normal medical range" })
  @IsOptional()
  @ValidateNested()
  @Type(() => NormalRangeDto)
  ...
  @ApiProperty({ enum: MeasurementCondition, example: MeasurementCondition.BEFORE_MEDICATION })
