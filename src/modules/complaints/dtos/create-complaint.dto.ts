...
export class CreateComplaintDto {
  ...
  @ApiProperty({
    example: '2024-01-15',
    description: 'When the complaint started',
  })
  @IsString()
  startDate: string;
  ...
  @ApiProperty({
    example: '3 days',
    description: 'How long the complaint has lasted',
  })
  @IsString()
  duration: string;
  ...
  @ApiProperty({
    example: 'Twice a day',
    description: 'How often the complaint occurs',
  })
  @IsString()
  frequency: string;
  ...
  @ApiPropertyOptional({
    example: '64a1f2c3e4b0a1234567890b',
    description: 'Drug ObjectId — required if isDrugRelated is true',
  })
